...
@Entity
@Table(name = "categorymappingentry")
@Filters({@Filter(name = "archiveFilterDef"), @Filter(name = "tenantFilterDef")})
public class CategoryMappingEntry extends CategoryMappingEntryBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = 547257241L;
}
