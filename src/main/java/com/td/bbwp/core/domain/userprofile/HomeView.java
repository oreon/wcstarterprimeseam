...
@Entity
@Table(name = "BBWP_HOME_VIEW")
public class HomeView extends HomeViewBase implements java.io.Serializable {
	private static final long serialVersionUID = 1199578996L;
}
