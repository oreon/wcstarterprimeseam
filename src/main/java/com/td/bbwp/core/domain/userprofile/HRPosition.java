...
@Entity
@Table(name = "BBWP_HR_POSITION")
public class HRPosition extends HRPositionBase implements java.io.Serializable {
	private static final long serialVersionUID = 543382789L;
}
