...
@Entity
@Table(name = "BBWP_FIELD_LOOKUP_TYPE_NAME")
public class FieldLookupTypeName extends FieldLookupTypeNameBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = -2099063105L;
}
