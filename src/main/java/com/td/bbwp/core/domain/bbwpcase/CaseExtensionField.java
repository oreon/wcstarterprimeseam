...
@Entity
@Table(name = "BBWP_CASE_EXTENSION_FIELD")
public class CaseExtensionField extends CaseExtensionFieldBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = -1754043926L;
}
