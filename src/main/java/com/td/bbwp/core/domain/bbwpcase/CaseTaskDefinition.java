...
@Entity
@Table(name = "BBWP_CASE_TASK_DEFINITION")
public class CaseTaskDefinition extends CaseTaskDefinitionBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = 192507343L;
}
