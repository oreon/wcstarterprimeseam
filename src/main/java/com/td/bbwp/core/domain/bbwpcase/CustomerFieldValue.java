...
@Entity
@Table(name = "BBWP_CUSTOMER_FIELD_VALUE")
public class CustomerFieldValue extends CustomerFieldValueBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = -1059243680L;
}
