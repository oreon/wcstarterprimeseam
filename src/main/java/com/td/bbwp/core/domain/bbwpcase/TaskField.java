...
@Entity
@Table(name = "BBWP_TASK_FIELD")
public class TaskField extends TaskFieldBase implements java.io.Serializable {
	private static final long serialVersionUID = -1243423168L;
}
