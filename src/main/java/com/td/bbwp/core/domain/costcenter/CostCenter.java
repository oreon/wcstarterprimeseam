...
@Entity
@Table(name = "BBWP_COST_CENTER")
public class CostCenter extends CostCenterBase implements java.io.Serializable {
	private static final long serialVersionUID = 115444332L;
}
