...
@Entity
@Table(name = "BBWP_CASE_TASK_FIELD_VALUE")
public class CaseTaskFieldValue extends CaseTaskFieldValueBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = 289145611L;
}
