...
@Entity
@Table(name = "BBWP_UNAVAILABILITY_REASON")
public class UnavailabilityReason extends UnavailabilityReasonBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = -95501528L;
}
