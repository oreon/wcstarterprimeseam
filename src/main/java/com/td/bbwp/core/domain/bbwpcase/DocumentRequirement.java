...
@Entity
@Table(name = "BBWP_DOCUMENT_REQUIREMENT")
public class DocumentRequirement extends DocumentRequirementBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = -853634577L;
}
