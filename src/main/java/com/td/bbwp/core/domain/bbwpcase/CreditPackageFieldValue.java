...
@Entity
@Table(name = "BBWP_CREDIT_PACKAGE_FIELD_VALUE")
public class CreditPackageFieldValue extends CreditPackageFieldValueBase
		implements
			java.io.Serializable {
	private static final long serialVersionUID = 1841449491L;
}
